...
- **Sous-titre panneau Plus (version finale)** : « L'application est gratuite, **les membres Plus** auront accès à : » — le fragment « les membres Plus » est doré + gras (`<strong class="plus-gold">`), il introduit la liste des bénéfices. Décliné dans les 12 langues. Remplace l'ancienne formulation « seul le menu Ma Playlists est réservé aux membres Plus ».
